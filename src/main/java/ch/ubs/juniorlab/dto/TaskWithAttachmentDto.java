...
public class TaskWithAttachmentDto {
    ...
    public BigDecimal getBudgetChf() { return budgetChf; }
    public LocalDate getDeadline() { return deadline; }
    public Integer getMaxFileSizeMb() { return maxFileSizeMb; }
    public String getChannel() { return channel; }
    public String getHandoverMethod() { return handoverMethod; }
    ...
    public Boolean getVoiceover() { return voiceover; }
    public Boolean getDisclaimer() { return disclaimer; }
    public String getBrandingRequirements() { return brandingRequirements; }
    public String getFormat() { return format; }
    public String getFileFormat() { return fileFormat; }
    public String getSocialMediaPlatforms() { return socialMediaPlatforms; }
    ...
    public Integer getPrintQualityDpi() { return printQualityDpi; }
    public String getMountingType() { return mountingType; }
    public Integer getPhotoCount() { return photoCount; }

    public AttachmentInfoDto getAttachment() { return attachment; }
