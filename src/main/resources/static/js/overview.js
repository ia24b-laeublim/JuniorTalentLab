...
function updatePagination(newPage) {
    ...
    loadAcceptedTasks(pagination);
}

/** Loads Accepted Tasks for given page */
function loadAcceptedTasks(page) {
    fetch(`/api/tasks/accepted?page=${page}`)
        ...
        .then(data => {
            ...
            if (data.length === 0) {
                container.innerHTML = `
                    <div style="text-align: center; padding: 60px 20px; color: #666;">
                        ...
                        <p style="font-size: 16px;">Check back later for accepted tasks!</p>
                    </div>
                `;
                return;
            }
            ...
            data.forEach(task => {
                ...
                const progress = task.progress || "Started";
                ...
                card.innerHTML = `
                  ...
                  <div style="display: flex; gap: 1rem;">
                    <div style="flex: 0 0 250px; display: flex; flex-direction: column; gap: 0.5rem;">
                      ...
                      <div class="popup-row" style="background-color: #f5f5f5; padding: 0.5rem;"><span>Progress</span><span>${progress}</span></div>
                    </div>
